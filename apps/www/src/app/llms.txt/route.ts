...
function buildLlmsTxt() {
  const lines = [
    ...
    "",
    "Monorch is a TypeScript AI control-plane library (`@monorch/ai`) backed by a Rust execution engine (`@monorch/runtime`). It is not a framework, HTTP stack, ORM, Studio, or RAG product. Bring your own HTTP server (Fastify, Hono, Nest, or anything else).",
    "",
    "## Product lock",
    "",
